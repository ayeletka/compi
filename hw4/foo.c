...
MOV(IND(180000011), IMM(T_STRING));
MOV(IND(180000012), IMM(1));
MOV(IND(180000013), IMM(97));
MOV(IND(180000014), IMM(T_STRING));
MOV(IND(180000015), IMM(1));
MOV(IND(180000016), IMM(50));
...
/*const*/
MOV(R0, IMM(180000014));

PUSH(R0);
/* push number of arguments */
PUSH(IMM(1));
/*fvar */
MOV(R0, IND(180000055));
