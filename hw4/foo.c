...
MOV(IND(180000007), IMM(2));
MOV(IND(180000008), IMM(T_FRAC));
MOV(IND(180000009), IMM(1));
MOV(IND(180000010), IMM(2));
MOV(IND(180000011), IMM(T_FRAC));
MOV(IND(180000012), IMM(-1));
MOV(IND(180000013), IMM(2));
...
PUSH(LABEL(DENOMINATOR));
PUSH(IMM(0));
CALL(MAKE_SOB_CLOSURE);
DROP(IMM(2));
MOV(IND(180000054), R0);
PUSH(LABEL(NUMERATOR));
PUSH(IMM(0));
CALL(MAKE_SOB_CLOSURE);
DROP(IMM(2));
