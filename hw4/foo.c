...
MOV(IND(180000017), IMM(3));
MOV(IND(180000018), IMM(T_INTEGER));
MOV(IND(180000019), IMM(2));
MOV(IND(180000020), IMM(T_PAIR));
MOV(IND(180000021), IMM(180000008));
MOV(IND(180000022), IMM(180000001));
MOV(IND(180000023), IMM(T_PAIR));
MOV(IND(180000024), IMM(180000016));
MOV(IND(180000025), IMM(180000010));
...
MOV(IND(180000047), IMM(999999));
MOV(IND(180000048), IMM(999999));
...
MOV(IND(180000058), IMM(999999));
MOV(IND(180000059), IMM(999999));
...
CALL(MAKE_SOB_CLOSURE);
DROP(IMM(2));
MOV(IND(180000063), R0);
PUSH(LABEL(STRING_2_SYMBOL));
PUSH(IMM(0));
CALL(MAKE_SOB_CLOSURE);
DROP(IMM(2));
MOV(IND(180000064), R0);
PUSH(LABEL(CHECK_EQ_OBJECT));
PUSH(IMM(0));
CALL(MAKE_SOB_CLOSURE);
DROP(IMM(2));
MOV(IND(180000065), R0);
