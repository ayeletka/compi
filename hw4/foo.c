...
MOV(IND(180000006), IMM(T_STRING));
MOV(IND(180000007), IMM(1));
MOV(IND(180000008), IMM(97));
MOV(IND(180000009), IMM(T_SYMBOL));
MOV(IND(180000010), IMM(180000006));
MOV(IND(180000011), IMM(T_INTEGER));
MOV(IND(180000012), IMM(2));
MOV(IND(180000013), IMM(T_INTEGER));
MOV(IND(180000014), IMM(3));
MOV(IND(180000015), IMM(T_INTEGER));
MOV(IND(180000016), IMM(5));
MOV(IND(180000017), IMM(T_STRING));
MOV(IND(180000018), IMM(5));
MOV(IND(180000019), IMM(115));
MOV(IND(180000020), IMM(104));
MOV(IND(180000021), IMM(117));
MOV(IND(180000022), IMM(103));
MOV(IND(180000023), IMM(115));
...
CALL(MAKE_SOB_CLOSURE);
DROP(IMM(2));
MOV(IND(180000061), R0);
PUSH(LABEL(STRING_2_SYMBOL));
PUSH(IMM(0));
CALL(MAKE_SOB_CLOSURE);
DROP(IMM(2));
MOV(IND(180000062), R0);
...
MOV(IND(190000000), IMM(180000009));
...
PUSH(R0);
/*const*/
MOV(R0, IMM(180000011));

PUSH(R0);
/*const*/
MOV(R0, IMM(180000017));

PUSH(R0);
/*const*/
MOV(R0, IMM(180000015));
