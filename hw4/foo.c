...
MOV(R10, IMM(0));
MOV(R11, IMM(1));
closureEnvLoopLabel1078:
CMP(R10,IMM(0));
JUMP_EQ(closureEnvLoopEndLabel1077);
MOV(INDD(R9,R11), INDD(R8,R10));
INCR(R10);
INCR(R11);
JUMP(closureEnvLoopLabel1078);
closureEnvLoopEndLabel1077: 
MOV(R12, FPARG(1));
PUSH(R12);
CALL(MALLOC);
...
MOV(R10, IMM(0));
MOV(R11, IMM(2));
closureParameterLoopLabel1080:
CMP(R10,R12);
JUMP_EQ(closureParameterLoopEndLabel1079);
MOV(R13,INDD(R9,IMM(0)));
MOV(INDD(R13,R10), FPARG(R11));
INCR(R10);
INCR(R11);
JUMP(closureParameterLoopLabel1080);
closureParameterLoopEndLabel1079: 
...
/* closure body ...*/
MOV(INDD(R0,IMM(2)), LABEL(closureBodyLabel1082));
JUMP(closureEndLabel1081);
closureBodyLabel1082:
PUSH(FP);
MOV(FP,SP);
/* lambda simple body */
...
CMP(R0, FALSE);
JUMP_EQ(labelElse1096);
/* pvar */
MOV(R10, IMM(0));
ADD(R10,IMM(2));
MOV(R0, FPARG(R10));

JUMP(labelIfExit1097);
labelElse1096:
/*ifExp*/
/*ifExp*/
/* applic */
...
MOV(R10, IMM(0));
MOV(R11, IMM(1));
closureEnvLoopLabel1068:
CMP(R10,IMM(0));
JUMP_EQ(closureEnvLoopEndLabel1067);
MOV(INDD(R9,R11), INDD(R8,R10));
INCR(R10);
INCR(R11);
JUMP(closureEnvLoopLabel1068);
closureEnvLoopEndLabel1067: 
MOV(R12, FPARG(1));
PUSH(R12);
CALL(MALLOC);
DROP(1);/* put old params in R9 */
...
MOV(R10, IMM(0));
MOV(R11, IMM(2));
closureParameterLoopLabel1070:
CMP(R10,R12);
JUMP_EQ(closureParameterLoopEndLabel1069);
MOV(R13,INDD(R9,IMM(0)));
MOV(INDD(R13,R10), FPARG(R11));
INCR(R10);
INCR(R11);
JUMP(closureParameterLoopLabel1070);
closureParameterLoopEndLabel1069: 
MOV(INDD(R9,IMM(0)),R13);
/* Calling malloc for closure, env and body. */
PUSH(IMM(3));
CALL(MALLOC);
...
MOV(INDD(R0,IMM(1)), R9);
/* closure body ...*/
MOV(INDD(R0,IMM(2)), LABEL(closureBodyLabel1072));
JUMP(closureEndLabel1071);
closureBodyLabel1072:
PUSH(FP);
MOV(FP,SP);
/* lambda var body */
/* pop old fp */
...
ADD(R15,IMM(1));
ADD(R14,IMM(2));
closurePushLoopLabel1075:
CMP(R4,R13);
JUMP_EQ(closureParameterLoopEndLabel1076);
MOV(R1, FPARG(R14));
PUSH(R1);
MOV(R1, FPARG(R15));
PUSH(R1);
...
INCR(R4);
DECR(R15);
JUMP(closurePushLoopLabel1075);closureParameterLoopEndLabel1076:
DROP(R13);
JUMP(EndLabel1074);
...
MOV(R10, IMM(0));
MOV(R11, IMM(1));
closureEnvLoopLabel1019:
CMP(R10,IMM(0));
JUMP_EQ(closureEnvLoopEndLabel1018);
MOV(INDD(R9,R11), INDD(R8,R10));
INCR(R10);
INCR(R11);
JUMP(closureEnvLoopLabel1019);
closureEnvLoopEndLabel1018: 
MOV(R12, FPARG(1));
PUSH(R12);
CALL(MALLOC);
DROP(1);/* put old params in R9 */
...
INCR(R10);
INCR(R11);
JUMP(closureParameterLoopLabel1021);
...
MOV(INDD(R0,IMM(1)), R9);
/* closure body ...*/
MOV(INDD(R0,IMM(2)), LABEL(closureBodyLabel1023));
JUMP(closureEndLabel1022);
closureBodyLabel1023:
PUSH(FP);
MOV(FP,SP);
/* lambda simple body */
/* check if number of params is correct */
...
MOV(R10, IMM(0));
MOV(R11, IMM(1));
closureEnvLoopLabel1055:
CMP(R10,IMM(1));
JUMP_EQ(closureEnvLoopEndLabel1054);
MOV(INDD(R9,R11), INDD(R8,R10));
INCR(R10);
INCR(R11);
JUMP(closureEnvLoopLabel1055);
closureEnvLoopEndLabel1054: 
MOV(R12, FPARG(1));
PUSH(R12);
CALL(MALLOC);
DROP(1);/* put old params in R9 */
...
MOV(R10, IMM(0));
MOV(R11, IMM(2));
closureParameterLoopLabel1057:
CMP(R10,R12);
JUMP_EQ(closureParameterLoopEndLabel1056);
MOV(R13,INDD(R9,IMM(0)));
MOV(INDD(R13,R10), FPARG(R11));
INCR(R10);
INCR(R11);
JUMP(closureParameterLoopLabel1057);
closureParameterLoopEndLabel1056: 
MOV(INDD(R9,IMM(0)),R13);
/* Calling malloc for closure, env and body. */
PUSH(IMM(3));
CALL(MALLOC);
...
MOV(INDD(R0,IMM(1)), R9);
/* closure body ...*/
MOV(INDD(R0,IMM(2)), LABEL(closureBodyLabel1059));
JUMP(closureEndLabel1058);
closureBodyLabel1059:
PUSH(FP);
MOV(FP,SP);
/* lambda simple body */
/* check if number of params is correct */
...
CMP(R0, FALSE);
JUMP_EQ(labelElse1065);
/* pvar */
MOV(R10, IMM(1));
ADD(R10,IMM(2));
MOV(R0, FPARG(R10));

JUMP(labelIfExit1066);
labelElse1065:
/* tc-applic */
...
/* loop over frame, R6 <- running indx */
MOV(R6, IMM(0));
closureParameterLoopLabel1060:
CMP(R6, R5);
JUMP_EQ(closureParameterLoopEndLabel1061);
MOV(FPARG(R3), STARG(R4));
DECR(R4);
DECR(R3);
INCR(R6);
JUMP(closureParameterLoopLabel1060);
closureParameterLoopEndLabel1061:
CMP(R5,R2);
JUMP_GE(greaterLabel1063);
DROP(R5);
SUB(R2,R5);
DROP(R2);
DROP(1);JUMP(endLabel1062);
greaterLabel1063:
CMP(R5,R2);
JUMP_EQ(equalLabel1064);
MOV(R7,R5);
SUB(R5,R2);
SUB(R7,R5);
DROP(R7);
...
MOV(R10, IMM(0));
MOV(R11, IMM(1));
closureEnvLoopLabel1042:
CMP(R10,IMM(1));
JUMP_EQ(closureEnvLoopEndLabel1041);
MOV(INDD(R9,R11), INDD(R8,R10));
INCR(R10);
INCR(R11);
JUMP(closureEnvLoopLabel1042);
closureEnvLoopEndLabel1041: 
MOV(R12, FPARG(1));
PUSH(R12);
CALL(MALLOC);
DROP(1);/* put old params in R9 */
...
MOV(R10, IMM(0));
MOV(R11, IMM(2));
closureParameterLoopLabel1044:
CMP(R10,R12);
JUMP_EQ(closureParameterLoopEndLabel1043);
MOV(R13,INDD(R9,IMM(0)));
MOV(INDD(R13,R10), FPARG(R11));
INCR(R10);
INCR(R11);
JUMP(closureParameterLoopLabel1044);
closureParameterLoopEndLabel1043: 
MOV(INDD(R9,IMM(0)),R13);
/* Calling malloc for closure, env and body. */
PUSH(IMM(3));
CALL(MALLOC);
...
MOV(INDD(R0,IMM(1)), R9);
/* closure body ...*/
MOV(INDD(R0,IMM(2)), LABEL(closureBodyLabel1046));
JUMP(closureEndLabel1045);
closureBodyLabel1046:
PUSH(FP);
MOV(FP,SP);
/* lambda simple body */
/* check if number of params is correct */
...
CMP(R0, FALSE);
JUMP_EQ(labelElse1052);
/* pvar */
MOV(R10, IMM(0));
ADD(R10,IMM(2));
MOV(R0, FPARG(R10));

JUMP(labelIfExit1053);
labelElse1052:
/* tc-applic */
...
/* loop over frame, R6 <- running indx */
MOV(R6, IMM(0));
closureParameterLoopLabel1047:
CMP(R6, R5);
JUMP_EQ(closureParameterLoopEndLabel1048);
MOV(FPARG(R3), STARG(R4));
DECR(R4);
DECR(R3);
INCR(R6);
JUMP(closureParameterLoopLabel1047);
closureParameterLoopEndLabel1048:
CMP(R5,R2);
JUMP_GE(greaterLabel1050);
DROP(R5);
SUB(R2,R5);
DROP(R2);
DROP(1);JUMP(endLabel1049);
greaterLabel1050:
CMP(R5,R2);
JUMP_EQ(equalLabel1051);
MOV(R7,R5);
SUB(R5,R2);
SUB(R7,R5);
DROP(R7);
...
MOV(R10, IMM(0));
MOV(R11, IMM(1));
closureEnvLoopLabel1025:
CMP(R10,IMM(1));
JUMP_EQ(closureEnvLoopEndLabel1024);
MOV(INDD(R9,R11), INDD(R8,R10));
INCR(R10);
INCR(R11);
JUMP(closureEnvLoopLabel1025);
closureEnvLoopEndLabel1024: 
MOV(R12, FPARG(1));
PUSH(R12);
CALL(MALLOC);
DROP(1);/* put old params in R9 */
...
MOV(R10, IMM(0));
MOV(R11, IMM(2));
closureParameterLoopLabel1027:
CMP(R10,R12);
JUMP_EQ(closureParameterLoopEndLabel1026);
MOV(R13,INDD(R9,IMM(0)));
MOV(INDD(R13,R10), FPARG(R11));
INCR(R10);
INCR(R11);
JUMP(closureParameterLoopLabel1027);
closureParameterLoopEndLabel1026: 
MOV(INDD(R9,IMM(0)),R13);
/* Calling malloc for closure, env and body. */
PUSH(IMM(3));
CALL(MALLOC);
...
MOV(INDD(R0,IMM(1)), R9);
/* closure body ...*/
MOV(INDD(R0,IMM(2)), LABEL(closureBodyLabel1029));
JUMP(closureEndLabel1028);
closureBodyLabel1029:
PUSH(FP);
MOV(FP,SP);
/* lambda var body */
/* pop old fp */
...
INCR(R4);
DECR(R15);
JUMP(closurePushLoopLabel1032);closureParameterLoopEndLabel1033:
DROP(R13);
JUMP(EndLabel1031);
...
CMP(R0, FALSE);
JUMP_EQ(labelElse1039);
/*const*/
MOV(R0, IMM(2));

JUMP(labelIfExit1040);
labelElse1039:
/* tc-applic */
...
CMP(R6, R5);
JUMP_EQ(closureParameterLoopEndLabel1035);
MOV(FPARG(R3), STARG(R4));
DECR(R4);
DECR(R3);
INCR(R6);
JUMP(closureParameterLoopLabel1034);
closureParameterLoopEndLabel1035:
CMP(R5,R2);
JUMP_GE(greaterLabel1037);
DROP(R5);
SUB(R2,R5);
DROP(R2);
DROP(1);JUMP(endLabel1036);
greaterLabel1037:
CMP(R5,R2);
JUMP_EQ(equalLabel1038);
MOV(R7,R5);
SUB(R5,R2);
SUB(R7,R5);
DROP(R7);
